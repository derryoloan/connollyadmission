Public Class frmMasterMedicationList
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        If txtNewMedication.Text <> "" Then
            ...
            If myMaster.AddMedication() = True Then
                ...
                frmAdmission.dgvMeds.Rows.Add(1)
                frmAdmission.dgvMeds.Rows(RowCount).Cells(1).Value = myMaster.MedicationName
                frmAdmission.dgvMeds.Rows(RowCount).Cells(0).Value = myMaster.Medication_ID
                RowCount = RowCount + 1
    ...
    Private Sub lstvMasterMedicationList_DoubleClick(sender As Object, e As EventArgs) Handles lstvMasterMedicationList.DoubleClick
        ...
        frmAdmission.dgvMeds.Rows(RowCount).Cells(0).Value = lstvMasterMedicationList.SelectedItems(0).Text
        frmAdmission.dgvMeds.Rows(RowCount).Cells(1).Value = lstvMasterMedicationList.SelectedItems(0).SubItems(1).Text
        frmAdmission.dgvMeds.Columns(0).ReadOnly = True
        frmAdmission.dgvMeds.Columns(1).ReadOnly = True
        frmAdmission.dgvMeds.Rows(RowCount).Selected = True
        frmAdmission.dgvMeds.CurrentCell = frmAdmission.dgvMeds.Rows(RowCount).Cells(2)
        RowCount = RowCount + 1
